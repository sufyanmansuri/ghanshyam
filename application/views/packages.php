        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addNewPackage"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info" href="<?php echo base_url() . 'editOldC/' . $record->packageId; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery('ul.pagination li a').click(function(e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "packageListing/" + value);
