...
<script>
  function enableSub() {
    document.getElementById("Subcategory").className += " active";
    document.getElementById("Category").className = document.getElementById("Category").className.replace( /(?:^|\s)active(?!\S)/g , '' );
  }
</script>
</body>
