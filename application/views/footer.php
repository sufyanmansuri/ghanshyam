            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-widget">
                        ...
                        <p>The food served here is a cavalcade of taste & texture and has maintained the originality of
                            its quality. We feature innovative contemporary Indian cuisine clubbed with some continental
                            delicacies that create bold flavours with a modern twist. From our famous Chana Poori to
                            Paneer Tikka, from our Chana Masala to our lip-smacking sizzlers we offer a host of
                            delicious vegetarian delicacies which are offered to our customers post due diligence and
                            tasting.</p>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-link-contact">
                        ...
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: 18, Khodiyarnagar Society,
                                    <br>Opp.Vishalnagar Society,
                                    <br> Isanpur,Ahmedabad-382443. </p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Phone: <a href="callto:+919054173660">+91
                                        9054173660</a></p>
                            </li>
                            <li>
                                <p><i class="fas fa-envelope"></i>Email: <a
                                        href="mailto:ghanshyam@gmail.com">ghanshyam@gmail.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
...
">
                <h3 class="modal-title w-100 dark-grey-text font-weight-bold my-3" id="myModalLabel"><strong
                        class="white-text">Sign in</strong></h3>
...
if (isset($_GET['status']) && $_GET['status'] == 'wrong') {?>
                ...
                <form role="form" id="loginAccount" action="<?php echo base_url() ?>Home/loginAccount" method="post"
                    role="form">
                    <!--Body-->
    ...
    echo $pid;
                    ...
                    <div class="md-form pb-3">
                        ...
                        <p class="font-small blue-text d-flex justify-content-end"><a
                                href="<?=base_url('customerForgotPassword')?>" class="blue-text ml-1">
                                Forgot Password?</a></p>
                    </div>
            ...
            <div class="modal-footer mx-5 pt-3 mb-1">
                <p class="font-small grey-text d-flex justify-content-end">Not a member? <a href="javascript:void(0);"
                        class="blue-text ml-1 newmodel" data-dismiss="modal" data-toggle="modal"
                        data-target="#elegantSignupModalForm">
                        Sign Up</a></p>
            </div>
        </div>
        <!--/.Content-->
...
<form role="form" id="createAccount" action="<?php echo base_url() ?>Home/createAccount" method="post" role="form">
    <div class="modal fade" id="elegantSignupModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content form-elegant">
                ...
                <div class="modal-header text-center" style="background: #d33b33;">
                    <h3 class="modal-title w-100 dark-grey-text font-weight-bold my-3" id="myModalLabel"><strong
                            class="white-text">Sign up</strong></h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="white-text">&times;</span>
                    </button>
                </div>
    ...
    echo $pid;
                    ...
                    <div class="text-center mb-3">
                        <button type="submit" id="regsub" class="btn hvr hvr-hover" style="box-shadow:none;">Sign
                            up</button>
                    </div>
                </div>
                <!--Footer-->
                <div class="modal-footer mx-5 pt-3 mb-1">
                    <p class="font-small grey-text d-flex justify-content-end">Already a member? <a href="#"
                            class="blue-text ml-1 " data-dismiss="modal" data-toggle="modal"
