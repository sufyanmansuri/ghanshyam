                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="payment-icon">
                                    <ul>
                                        <li><img class="img-fluid" src="<?= base_url(); ?>asset/image/payment-icon/1.png" alt=""></li>
                                        <li><img class="img-fluid" src="<?= base_url(); ?>asset/image/payment-icon/2.png" alt=""></li>
                                        <li><img class="img-fluid" src="<?= base_url(); ?>asset/image/payment-icon/3.png" alt=""></li>
                                        <li><img class="img-fluid" src="<?= base_url(); ?>asset/image/payment-icon/5.png" alt=""></li>
                                        <li><img class="img-fluid" src="<?= base_url(); ?>asset/image/payment-icon/7.png" alt=""></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
